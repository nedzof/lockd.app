    ...
    <div className="w-full">
      {!showOptions ? (
        <button
          ...
          className="w-full inline-flex items-center justify-center px-3 py-1 text-xs font-medium rounded-md shadow-sm text-gray-200 bg-white/10 hover:bg-white/15 border border-gray-700/30 focus:outline-none focus:ring-1 focus:ring-[#00ffa3]/30 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLocking ? (
            <>
            ...
            <>
              <FiLock className="mr-1.5" /> Lock BSV
            </>
          )}
        </button>
      ) : (
        <div className="bg-[#2A2A40]/30 p-3 rounded-md border border-gray-800/20 mt-2">
          <div className="grid grid-cols-2 gap-2 mb-3">
            <div>
              ...
              <input
                ...
                min="0.00001"
                step="0.00001"
                className="w-full bg-white/5 border border-gray-800/20 rounded-md py-1.5 px-2 text-sm text-white focus:ring-[#00ffa3]/50 focus:border-[#00ffa3]/50"
              />
            </div>
            <div>
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="flex-1 inline-flex items-center justify-center px-3 py-1.5 border border-gray-800/20 text-sm font-medium rounded-md shadow-sm text-gray-300 bg-white/5 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              Cancel
            </button>
          </div>
