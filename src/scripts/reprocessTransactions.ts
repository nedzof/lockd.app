    ...
    try {
        ...
        const finalData = {
            ...
            metadata: {
                ...
                file_name: parsedTx.image?.file_name || '',
                file_size: parsedTx.image?.file_size || 0,
                ...
                parent_sequence: parsedTx.metadata.parent_sequence,
            ...
            image_format: parsedTx.image?.mime_type?.split('/')[1] || null,
