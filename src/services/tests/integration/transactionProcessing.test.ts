...
describe('Transaction Processing Integration Tests', () => {
    ...
    test('should process specific transaction a043fbcd', async () => {
        const tx: Transaction = {
            ...
            inputs: [],
            outputs: [{
                script: '6a4c6d7b226170706c69636174696f6e223a226c6f636b642e617070222c2274797065223a22766f74655f7175657374696f6e222c22706f73744964223a226d373367386269702d63656568336e307832222c2274696d657374616d70223a22323032352d30322d31335431343a34323a32372e3032355a222c' +
